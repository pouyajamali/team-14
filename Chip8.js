...
RunCycle: function()
{
  ...
  arrReg.push(Processor.REGISTER_SET.slice(0));
  arrStack.push(Processor.STACK.slice(0));
  arrMem.push(Processor.MEMORY.slice(0));
  arrVRAM.push(Processor.VRAM.slice(0));
  arrScreen.push(Processor.SCREEN);
  arrCanv.push(Processor.CANVAS);
  arrDraw.push(Processor.DRAW_FLAG);
  arrFunc.push(op);
